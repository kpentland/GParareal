...
This repository contains sample code for the pre-print by Pentland, Tamborrino, Sullivan, Buchanan, and Appel - "GParareal: A time-parallel ODE solver using Gaussian process emulation". Using the 'TESTNAME_Results.m' in each folder, one should be able to re-create the results from the paper.
